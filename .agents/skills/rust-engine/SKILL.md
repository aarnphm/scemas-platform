---
name: rust-engine
description: Use when editing or creating Rust files in crates/. Covers conventions, error handling, pipe-and-filter telemetry pattern, blackboard alerting pattern, and sqlx query rules. Do not use for typescript or frontend work.
---
