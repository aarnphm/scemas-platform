---
name: dashboard
description: Use when editing or creating TypeScript/TSX files in packages/. Covers PAC agent structure, tRPC routers, drizzle schema rules, typescript conventions, and the AccessManager/DataDistributionManager controllers. Do not use for Rust work.
---
