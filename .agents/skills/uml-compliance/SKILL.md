---
name: uml-compliance
description: Use when adding new structs, routes, database tables, or entity types. Provides the full UML class diagram inventory (controllers, boundary classes, entity classes) and cross-layer naming consistency rules. Do not use for routine code edits that don't introduce new entities.
---
