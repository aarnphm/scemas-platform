    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card p-4">
        <dl className="grid gap-4 md:grid-cols-2">
          <div>
            <dt className="text-xs uppercase tracking-[0.2em] text-muted-foreground">zone</dt>
            <dd className="mt-1 text-sm">{alert.zone}</dd>
          </div>
          <div>
            <dt className="text-xs uppercase tracking-[0.2em] text-muted-foreground">metric</dt>
            <dd className="mt-1 text-sm">{alert.metricType.replaceAll('_', ' ')}</dd>
          </div>
          <div>
            <dt className="text-xs uppercase tracking-[0.2em] text-muted-foreground">severity</dt>
          ...
          <div>
            <dt className="text-xs uppercase tracking-[0.2em] text-muted-foreground">triggered value</dt>
            <dd className="mt-1 text-sm">{alert.triggeredValue}</dd>
          </div>
          <div>
            <dt className="text-xs uppercase tracking-[0.2em] text-muted-foreground">opened</dt>
