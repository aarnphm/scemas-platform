/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dcd4b1de0affc21d8c68b108ffef8b6f)
// Runtime types generated with workerd@1.20260317.1 2025-05-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		HYPERDRIVE: Hyperdrive;
		ASSETS: Fetcher;
		INTERNAL_RUST_URL: "https://scemas-api.aarnphm.workers.dev";
		NEXT_PUBLIC_API_URL: "https://scemas-dashboard.aarnphm.workers.dev";
		SCEMAS_API: Fetcher /* scemas-api */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INTERNAL_RUST_URL" | "NEXT_PUBLIC_API_URL">> {}
}
