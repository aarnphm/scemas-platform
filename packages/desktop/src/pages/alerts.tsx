            ...
            <>
              ...
              <div className="divide-y">
                {filtered.map(alert => {
                  ...
                  const isLoading = inflightId === alert.id
                  return (
                    <div
                      key={alert.id}
                      className="group flex items-center justify-between px-4 transition-colors hover:bg-muted/50"
                    >
                      <Link
                        to="/alerts/$alertId"
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`rounded-full px-2 py-0.5 text-[11px] font-medium ${sev.cls}`}
                          >
                            {sev.label}
                          </span>
                        </div>
